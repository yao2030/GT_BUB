...
- (void)show
{
	...
	self.titleLabel.center = CGPointMake(MAINSCREEN_WIDTH/2,MAINSCREEN_HEIGHT/2 - 30);
	self.titleLabel.text = @"倒计时";
	
	self.subTitleLabel.center = CGPointMake(MAINSCREEN_WIDTH/2,MAINSCREEN_HEIGHT/2 + 30);
	self.subTitleLabel.text = @"向上滑动取消";
	
	self.centerLabel.center = CGPointMake(MAINSCREEN_WIDTH/2,MAINSCREEN_HEIGHT/2);

...
//cell的一些设置
#define ChatTextCellId        @"ChatTextCellId"
#define ChatImageCellId       @"ChatImageCellId"
#define ChatVoiceCellId       @"ChatVoiceCellId"
#define ChatMapCellId         @"ChatMapCellId"
#define ChatVideoCellId       @"ChatVideoCellId"
 ...
 */
typedef NS_ENUM(NSInteger, ChatConversationType) {
    ChatConversationTypeChat    = 1,
    ChatConversationTypeGroupChat = 2,
};

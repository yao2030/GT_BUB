...
//#import "Define.h"
#import "DeviceDefault.h"
#import <AVFoundation/AVFoundation.h>
#import "UUProgressHUD.h"
#import "UUAVAudioPlayer.h"
#import "ChatKeyBoardDatas.h"
#import "ChatKeyBordView.h"
...
#define SSChatBotomTop          MAINSCREEN_HEIGHT-SSChatBotomHeight-SafeAreaBottom_Height                    //底部视图的顶部
...
#define SSChatTextWidth      MAINSCREEN_WIDTH - (3*SSChatBtnSize + 5* SSChatBtnDistence)                       //输入框的宽度

#define SSChatTBottomDistence   8            //输入框上下间隙
#define SSChatBBottomDistence   8.5          //按钮上下间隙


@class ChatKeyBoardInputView;


@protocol ChatKeyBoardInputViewDelegate <NSObject>
...
@interface ChatKeyBoardInputView : UIView<UITextViewDelegate,AVAudioRecorderDelegate,ChatKeyBordViewDelegate>

@property(nonatomic,assign)id<ChatKeyBoardInputViewDelegate>delegate;
...
//传入底部视图进行frame布局
@property (strong, nonatomic) ChatKeyBordView   *mKeyBordView;

...
- (void)viewDidLoad {
    ...
    _mMapView = [[MKMapView alloc]initWithFrame:CGRectMake(0, [DeviceDefault shareCKDeviceDefault].safeAreaTopHeight , MAINSCREEN_WIDTH, MAINSCREEN_HEIGHT-[DeviceDefault shareCKDeviceDefault].safeAreaTopHeight)];

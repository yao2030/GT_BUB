...
//
//    override init(frame frameRect: CGRect, device: MTLDevice? = MTLCreateSystemDefaultDevice()) {
...
//        }
//
//        let vertexData: [Float] = [-scaleX, -scaleY, 0.0, 1.0,
...
//}
//
//extension CCPreviewView.Rotation {

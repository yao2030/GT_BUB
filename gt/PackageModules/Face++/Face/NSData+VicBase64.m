...
@implementation NSData (VicBase64)
...
+ (NSData *)dataFromBase64String:(NSString *)aString
{
    ...
    size_t outputLength;
    void *outputBuffer = VicNewBase64Decode([data bytes], [data length], &outputLength);
...
- (NSString *)base64EncodedString
{
    ...
    char *outputBuffer =
        VicNewBase64Encode([self bytes], [self length], false, &outputLength);
